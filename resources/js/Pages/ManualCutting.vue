        ...
        <main id="catalogSection" class="bg-[#393939] relative">
            <section>
                <div class="sm:container sm:mx-auto mx-[20px] relative">
                    <h3
                            class="text-[#16A34A] px-4 text-[36px] md:text-[56px] text-right"
                        >
                            Наши технологии
                        </h3>

                    <div class="text-white mt-[9px] lg:mb-[73px] mb-[28px]">
                        <h2 class="lg:text-[36px] text-[20px]">Процесс</h2>
                    ...
                    <div
                        class="lg:h-[600px] sm:max-h-[400px] max-h-[256px] rounded flex"
                    >
                        <ImgComparisonSlider class="rounded">
                            <img
                                slot="first"
                                src="/image/home.png"
                                style="width: 100%"
                            ...
                            <img
                                slot="second"
                                style="width: 100%"
                                src="/image/home-out.png"
                            />
                        </ImgComparisonSlider>
                    </div>

                    <div class="flex justify-center">
                        <h2 class="text-center mt-10 md:text-[36px] text-[25px] text-white lg:w-1/2">
            ...
            <section v-if="readyProjects?.length > 0" id="ourProjects">
                <div class="sm:container sm:mx-auto mx-[20px]">
                    ...
                    <div class="gap-6 my-8 md:pb-8 relative z-10">
                        ...
                        >
                            ...
                            >
                                <Link
                                    :href="route('project.single', project.id)"
                                    class="cursor-pointer rounded-[4px] block w-full mr-6"
                                    aria-hidden="true"
                                >
                                    <img
                                        :src="project.image_top"
                                        class="h-[306px] w-full object-cover rounded-[4px]"
                                        alt="Дом и баня"
                                    />
                                </Link>
                            </Slide>
            ...
            >
                <div class="sm:container sm:mx-auto mx-[20px] md:px-4">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        >
                            <CatalogForm type="ruchnaya-rubka" />
                        </div>
                        <div
            ...
            <section class="pb-20 pt-8 sm:mx-auto mx-[20px]">
                <div class="sm:container sm:mx-auto mx-[20px]">
                    ...
                    <div
                        class="pb-16 grid lg:grid-cols-2 gap-[30px] items-start lg:mt-[73px] mt-[33px]"
                    >
                        <div
                        ...
                        >
                            ...
                            <div
                                class="text-[14px] transition-all ease-out duration-500"
                                :class="
                                    selectedFaq == faq
