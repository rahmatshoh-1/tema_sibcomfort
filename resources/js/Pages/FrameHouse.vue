            ...
            <section>
                <div class="container mx-auto relative">
                    ...
                    <div class="flex justify-center">
                        <h2
                            class="text-center text-[25px] md:text-[36px] text-white lg:w-1/2 px-4"
                        >
                            Посмотрите на построенные нами наши дома, база
                            отдыха и баня
                        </h2>
                    </div>
                    <div class="pb-4 relative z-10 md:px-4">
                        ...
                        >
                            ...
                            >
                                ...
                                <span>
                                    <svg
                                        :class="{
                                            'rotate-180 ease-out transition duration-300':
                                                selectedFaq == faq,
                                        }"
