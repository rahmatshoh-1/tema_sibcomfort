...
export default {
    ...
    methods: {
        ...
        submit() {
            axios
                .put(route("products.update", this.item.id), this.item)
                .then((res) => {
                    Swal.fire({
                    ...
                    router.visit(route("products.index"), { replace: true });
                })
                .catch((err) => {
...
<template>
    <DashboardLayout>
        <div class="mb-6">
            <h2 class="font-bold text-xl">Редактировать продукт</h2>
        </div>
        <form class="sm:grid sm:grid-cols-2 gap-6" @submit.prevent="submit()">
            ...
            <div class="">
                <label class="block" for="">Скидки,акции итп :</label>
                <input type="text" class="form-controls" v-model="item.title" />
            </div>
            ...
            <div class="col-span-2 border-t-2 pt-3">
                <label class="block" for="image"> Изображение: </label>
                <input
                    id="image"
            ...
            <div class="col-span-2 border-t-2 pt-3">
                ...
                <div class="flex items-center justify-end gap-x-3">
                    <Link
                        ...
                        >Назад</Link
                    >
                    <button class="dash-btn" :href="route('products.index')">
                        Сохранить
                    </button>
                </div>
            </div>
