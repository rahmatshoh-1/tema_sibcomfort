        ...
        <div class="container mx-auto">
            <div class="grid grid-cols-12 gap-3">
                <div class="col-span-12 md:col-span-6 order-2 md:order-1">
                    <div  class="mt-10 font-medium text-white lg:text-[56px] text-[32px] text-center relative">К сожалению, такой страницы не существует.</div>
                ...
                <div class="col-span-12 md:col-span-6 order-1 md:order-2">
                    ...
                    <img src="/image/404.png" class="text-center" alt="404 сибкомфорт">
                    </div>
                </div>
            </div>
        </div>
